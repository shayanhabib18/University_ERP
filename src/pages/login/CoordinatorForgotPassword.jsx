...
export default function CoordinatorForgotPassword() {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      setEmail("");
      setTimeout(() => navigate("/login/coordinator"), 3000);
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-white p-4">
      <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-purple-700">Coordinator Forgot Password</h2>
        ...
        <form onSubmit={handleForgotPassword} className="space-y-4">
          <div>
            <label className="block text-gray-700 font-medium mb-2">Coordinator Email Address</label>
            <input
              type="email"
              value={email}
