                        ...
                        {f.status === "Active" ? (
                          ...
                          >
                            <path
                              ...
                              strokeLinejoin="round"
                              strokeWidth={2}
                              d="M18.364 5.636a9 9 0 010 12.728m0 0l-2.829-2.829m2.829 2.829L21 21M15.536 8.464a5 5 0 010 7.072m0 0l-2.829-2.829m-4.243 2.829a4.978 4.978 0 01-1.414-2.83m-1.414 5.658a9 9 0 01-2.828-2.828m0 0l5.658-5.657m-5.657 5.657l3.536-3.536"
                            />
                          </svg>
                        ) : (
                          <svg
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-2xl">
            <h2 className="text-xl font-semibold mb-4 text-gray-800">
              Assign Courses to{" "}
              {facultyList.find((f) => f.id === assigningId)?.name}
            </h2>
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-start mb-4">
              <h2 className="text-xl font-semibold text-gray-800">
                Documents for{" "}
                {facultyList.find((f) => f.id === viewingDocumentsFor)?.name}
              </h2>
              <button
            ...
            {facultyList.find((f) => f.id === viewingDocumentsFor)?.documents
              ?.length ? (
              <div className="space-y-3">
                {facultyList
                  .find((f) => f.id === viewingDocumentsFor)
                  ?.documents.map((doc) => (
                    <div
                      key={doc.id}
                    ...
                    >
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button
                          onClick={() =>
                            handleDeleteDocument(viewingDocumentsFor, doc.id)
                          }
              ...
              <div className="text-center py-8">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  This faculty member doesn't have any documents yet.
                </p>
              </div>
            )}
          </div>
